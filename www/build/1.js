...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__indicadores__ = __webpack_require__(934);
...
var IndicadoresPageModule = (function () {
    ...
    IndicadoresPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__indicadores__["a" /* IndicadoresPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_ferreterias_service__ = __webpack_require__(496);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_config__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_jquery__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_chart_js__ = __webpack_require__(880);
...
var IndicadoresPage = (function (_super) {
    ...
    IndicadoresPage.prototype.drawCharts = function () {
        ...
        */
        var indicadoresCanvas = __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#indicadores_donutChart");
        var indicadoresChart = new __WEBPACK_IMPORTED_MODULE_9_chart_js___default.a(indicadoresCanvas, {
            type: 'pie',
            data: {
                labels: ["P", "D", "n"],
                datasets: [{
        ...
        var variacionChartCanvas = __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#variacion_barChart");
        ...
        var variacionBarChart = new __WEBPACK_IMPORTED_MODULE_9_chart_js___default.a(variacionChartCanvas, {
            type: 'horizontalBar',
        ...
        var ableToClickVariacion = true;
        __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#variacionAdd").click(function () {
            if (ableToClickVariacion) {
                ...
                if (variacionNumMonths < variacionNumMax) {
                    ...
                    var alturaActual = __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#variacion_barChart").parents(".barChart_container").outerHeight(true);
                    __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#variacion_barChart").parents(".barChart_container").animate({
                ...
                if (variacionNumMonths >= variacionNumMax) {
                    __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#variacionAdd").stop().fadeOut(300);
                }
            }
        });
        /*
        ...
        */
        var ventasChartCanvas = __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#ventas_barChart");
        ...
        var ventasBarChart = new __WEBPACK_IMPORTED_MODULE_9_chart_js___default.a(ventasChartCanvas, {
            type: 'horizontalBar',
        ...
        var ableToClickVentas = true;
        __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#ventasAdd").click(function () {
            if (ableToClickVentas) {
                ...
                if (ventasNumMonths < ventasNumMax) {
                    ...
                    var alturaActual = __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#ventas_barChart").parents(".barChart_container").outerHeight(true);
                    __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#ventas_barChart").parents(".barChart_container").animate({
                        height: alturaActual + 30
                    }, 300, function () {
                ...
                if (ventasNumMonths >= ventasNumMax) {
                    __WEBPACK_IMPORTED_MODULE_8_jquery__("page-indicadores").last().find("#ventasAdd").stop().fadeOut(300);
                }
            }
        });
        /*
