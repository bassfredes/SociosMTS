...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home__ = __webpack_require__(933);
...
module.exports.easing = __webpack_require__(882);
module.exports.canvas = __webpack_require__(883);
module.exports.options = __webpack_require__(884);
...
var helpers = __webpack_require__(870);
...
var color = __webpack_require__(877);
var helpers = __webpack_require__(870);
...
module.exports = {};
module.exports.Arc = __webpack_require__(890);
module.exports.Line = __webpack_require__(891);
module.exports.Point = __webpack_require__(892);
module.exports.Rectangle = __webpack_require__(893);
...
/* MIT license */
var convert = __webpack_require__(886);
var string = __webpack_require__(888);
...
var helpers = __webpack_require__(870);
var basic = __webpack_require__(894);
var dom = __webpack_require__(895);
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(881)();

Chart.helpers = __webpack_require__(870);

// @todo dispatch these helpers into appropriated helpers/helpers.* file and write unit tests!
__webpack_require__(885)(Chart);

Chart.defaults = __webpack_require__(871);
Chart.Element = __webpack_require__(872);
Chart.elements = __webpack_require__(873);
Chart.Interaction = __webpack_require__(878);
Chart.platform = __webpack_require__(879);
...
var defaults = __webpack_require__(871);
...
var helpers = __webpack_require__(876);
...
var conversions = __webpack_require__(887);
...
/* MIT license */
var colorNames = __webpack_require__(889);
...
var defaults = __webpack_require__(871);
var Element = __webpack_require__(872);
var helpers = __webpack_require__(870);
...
var defaults = __webpack_require__(871);
var helpers = __webpack_require__(870);
var Interaction = __webpack_require__(878);
var platform = __webpack_require__(879);
...
var Element = __webpack_require__(872);
var helpers = __webpack_require__(870);
var Ticks = __webpack_require__(875);
...
var defaults = __webpack_require__(871);
var elements = __webpack_require__(873);
var helpers = __webpack_require__(870);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_noticias_service__ = __webpack_require__(498);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_ferreteria_model__ = __webpack_require__(927);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_chart_js__ = __webpack_require__(880);
...
var HomePage = (function (_super) {
    ...
    HomePage.prototype.drawChartNPS = function () {
        var full = 100;
        var total = this.ferreteria.indicadores.nps.locales[this.localSelected].total;
        this.npsValue = total;
        var p = this.ferreteria.indicadores.nps.locales[this.localSelected].p;
        var d = this.ferreteria.indicadores.nps.locales[this.localSelected].d;
        var n = this.ferreteria.indicadores.nps.locales[this.localSelected].n;
        /*
        ...
        */
        var ctx = __WEBPACK_IMPORTED_MODULE_9_jquery__("#home_donutChart").last();
        var myChart = new __WEBPACK_IMPORTED_MODULE_10_chart_js___default.a(ctx, {
            type: 'pie',
            data: {
                labels: ["P", "D", "n"],
                datasets: [{
    ...
    HomePage.prototype.openNoticia = function (page) {
        ...
        this.storage.get('id_token').then(function (id_token) {
            if (id_token !== null) {
                _this.storage.get("id_ferreteria").then(function (theID) {
                    ...
                    _this.noticiasService.getLast().then(function (noticiaData) {
                        _this.noticia = noticiaData;
                        if (_this.noticia._attachments) {
                            var attachments = Object.keys(_this.noticia._attachments);
                            _this.noticiasImage = _this.cfg.apiUrl + _this.cfg.noticias + '/' + _this.noticia._id + '/' + attachments[0];
                        }
                    });
                });
            }
