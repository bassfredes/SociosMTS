...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__eventos_detalle__ = __webpack_require__(930);
...
var EventosDetallePageModule = (function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_photo_viewer__ = __webpack_require__(505);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__protected_page_protected_page__ = __webpack_require__(874);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_eventos_service__ = __webpack_require__(502);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_proveedores_service__ = __webpack_require__(499);
...
var EventosDetallePage = (function (_super) {
    __extends(EventosDetallePage, _super);
    function EventosDetallePage(navCtrl, navParams, menuCtrl, storage, formBuilder, eventosService, photoViewer, appCtrl, toastCtrl, alertCtrl, proveedoresService, authService) {
        ...
        _this.participarB = _this.navParams.get('participar');
    ...
    EventosDetallePage.prototype.drawCharts = function () {
        var RDNChartCanvas = __WEBPACK_IMPORTED_MODULE_10_jquery__("page-eventos-detalle").last().find("#RDN");
        var meta = this.varsRDN.meta;
        var acuerdo = this.varsRDN.acuerdo;
        var avance = this.varsRDN.avance;
        var RDNChartData = {
        ...
        var RDNBarChart = new __WEBPACK_IMPORTED_MODULE_11_chart_js___default.a(RDNChartCanvas, {
            type: 'horizontalBar',
            data: RDNChartData,
            options: {
                scales: {
